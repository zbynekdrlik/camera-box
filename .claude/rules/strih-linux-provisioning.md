...
| (I) genlock render-tick rtprio grant + no crash popups (23.9.2026, imag parity) | step 11c | items 32 (FAIL / NOTE) + 33 (FAIL) | `strih_rtprio_limits_path`/`_text`/`_grant_ok`/`strih_rtprio_session_verdict`, `strih_crash_popup_units`/`_unit_ok`/`_verdict` |
