...
- The retired Windows strih PC's on-box NIC-fail self-heal watcher (#1199) was REMOVED with the PC (issue 1317 part 4 — its scripts, decision mirror, test and rule are in git history only); the retired-remnant inventory + the ONE "is this the Linux strih" authority live in `.claude/rules/obs-fleet-list.md`
