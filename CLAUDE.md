...
- Genlock OBS (deployed state, monorepo direction, NDI input mapping, timecode lag, the #266 NDI-receive stuck-state watchdog `scripts/stuck-watchdog.py`) → load `.claude/skills/genlock`
