...
PSFAST
  ...
  # #1115 + issue 1372: the FULL-mode plugin deploys + byte verifies (distroav to its ProgramData
  # load path, the paced obs-vban into Program Files) live in scripts/lib/genlock-plugin-deploy.sh.
