...
compare_observed() {
  ...
  # could not be fetched) it is judged exactly like a lone manifest=. The E2E only does that for a
  # full-only build; a fast fetch outage omits the pin upstream (manifest-autosource.sh).
