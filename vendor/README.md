...
|---|---|---|
| `output_fps` | `60` | OBS log `video settings reset: … fps: <n>/1` (the #11 60fps rollout — both OBS canvas/output at 60fps, cam1 emits 60fps NDI; full-chain zero-loss proven at 60. Was `30` pre-#11; a drop back to `30` is now drift) |
