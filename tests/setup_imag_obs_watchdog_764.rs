...
fn setup_imag_provisions_watchdog_step_24_764() {
    ...
    assert!(
        ...
        "{SETUP}: TOTAL_STEPS must be 28 (step 24 imag-obs-watchdog #764 + step 25 touchpad usability #779 + step 26 imag-maxperf #791 + step 27 picom vsync compositor issue 1146 + step 28 imag :8899 bundle-state-server issue 1299) — the watchdog step must still be counted"
    );
    assert!(
