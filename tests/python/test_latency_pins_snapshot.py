...
class TestActiveCameraNumbers:
    def test_default_is_cam2_cam3(self, monkeypatch):
        ...
        # camera-set.sh's CAMERA_ACTIVE_SET = "cam2 cam3".
...
class TestSnapshotBoxPins:
    def test_reads_main_and_mv_for_each_camera_in_the_default_active_set(self, monkeypatch):
        # #1134: no CAMERA_ACTIVE_SET override -> the default active set (cam2/cam3, cam1 retired
        # 2026-08-19 grabber hw fault), never the old literal cam1..7 sweep. A retired camera
